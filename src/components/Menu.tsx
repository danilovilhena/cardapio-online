...
const Menu = () => {
            ...
            itens: [
                {
                    ...
                    price: "R$19,00",
                    photo: "https://goentrega.online/tim.php?src=https://goentrega.online/uploads/images/2021/04/whatsapp-image-2021-04-01-at-20-12-45.jpeg&w=180&h=180"
                },
                {
                    ...
                    price: "R$60,00",
                    photo: "https://goentrega.online/tim.php?src=https://goentrega.online/uploads/images/2021/07/egg-4.jpeg&w=180&h=180"
                },
                {
    ...
    return (
        <main>
            {sections.map((el) => <MenuSection title={el.title}/>)}
        </main>
    )
}
